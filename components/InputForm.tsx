            ...
            <div className="border-t border-slate-100 pt-8 space-y-6" onFocus={() => onSectionFocus?.('photography')}>
               ...
               {data.hasPhotography && (
                 <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-in fade-in duration-300">
                    ...
                    <div><label className={labelClasses}>拘束時間（1日）</label><input type="text" value={data.photoDetails.hours} onChange={(e) => onChange({...data, photoDetails: {...data.photoDetails, hours: e.target.value}})} className={inputClasses} placeholder="8" /></div>

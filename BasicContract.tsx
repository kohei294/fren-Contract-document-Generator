    ...
    <div className="serif-font">
      ...
      <div className={pageClass}>
        <section>
          ...
          <div className={textClass}>
            ...
            3. 成果物の引渡しは, 検査合格の通知が受託者に到達した時に完了するものとする。成果物が電子データその他の無形物である場合においても, 本項に定める検査合格の通知をもって引渡しが完了したものとする。<br/>
      ...
      <div className={pageClass}>
        <section>
          ...
          <div className={textClass}>
            1. 委託者又は受託者は, 相手方が本契約又は個別契約のいずれかの条項に違反し, 相当期間を定めて催告したにもかかわらず当該違反が<td>是正されないときは, 本契約及び個別契約の全部又は一部を解除することができる。<br/>
      ...
      <div className={pageClass}>
        <section>
          ...
          <div className={textClass}>本契約は日本法に準拠し, 解釈されるものとする。本契約に関する一切の紛争については, 東京地方裁判所又は東京簡易裁判所を第一審の専属的合意管轄裁判所とする。</div>
